        ...
        <div>
           <div className='flex  items-center md:justify-center justify-start gap-8 m-10'>
                <Pdf targetRef={ref} filename="course.pdf">
                    {({toPdf})=><button onClick={toPdf} className='bg-transparent dark:text-white border-inherit hover:bg-transparent text-black btn'><BsDownload className=' text-3xl font-bold'></BsDownload>
                    </button>}
                </Pdf>
                <h1 className='md:text-center md:text-3xl text-2xl font-bold dark:text-white'>Course in  Details</h1>
           </div>
