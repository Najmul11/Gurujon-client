        ...
        <div className='container mx-auto mt-6'>
            <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 mx-auto" >
                ...
                <div>
                    ...
                    <div className='mt-4'>
                        <button onClick={googleSignIn} type="submit" className="btn w-full border-inherit hover:bg-transparent text-black bg-transparent focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><FcGoogle className='text-2xl mr-2'/> Continue with Google</button>
